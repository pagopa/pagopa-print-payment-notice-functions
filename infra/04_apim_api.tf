locals {
  repo_name = "pagopa-print-payment-notice-functions"

  display_name = "Payment Notices Print Functions APIs"
  description  = "Payment Notices Print Functions APIs"
  path         = "print-payment-notice-functions"
