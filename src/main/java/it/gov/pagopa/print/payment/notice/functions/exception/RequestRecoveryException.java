...
public class RequestRecoveryException extends PaymentNoticeManagementException {
     ...
     */
    public RequestRecoveryException(String message, int statusCode, Throwable cause) {
     ...
     * @param statusCode Error code
     */
    public RequestRecoveryException(String message, int statusCode) {
